...
file_path = "./encrypted-secrets.yaml"
...
encrypted_data = crypto_client.decrypt(EncryptionAlgorithm.rsa_oaep, file_contents)

# Write the encrypted data to a new file or overwrite the existing file
encrypted_file_path = "./decrypted-secrets.yaml"
with open(encrypted_file_path, "wb") as encrypted_file:
    encrypted_file.write(encrypted_data.plaintext)
os.remove(file_path)
